...
function ProjectCard({ project }) {
  const { title, description, technologies, category, demoUrl, githubUrl } = project;
    ...
    >
      <div className="project-card__header">
        <div className="project-card__header-left">
          {/* Folder icon */}
          <svg className="project-card__folder" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
